...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/precrati/Telegram-iOS/build-input/gen/project/bazel',
    '/private/var/tmp/_bazel_precrati/77dcaa67d78e8899a54a0829084257de/execroot/__main__',
    '/private/var/tmp/_bazel_precrati/77dcaa67d78e8899a54a0829084257de',
    'ios_x86_64',
    {
        'ios_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/precrati/Library/Application Support/Tulsi/0.20220209.88/Bazel',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            startup = [],
            build = [
                '--override_repository=build_configuration=/Users/precrati/Telegram-iOS/build-input/configuration-repository',
                ...
                '--define=telegramVersion=9.5.3',
                '--disk_cache=/Users/precrati/telegram-bazel-cache',
                '--//Telegram:disableExtensions',
            ],
        ),
    ),
